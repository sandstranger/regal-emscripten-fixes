...
iffFormulae = {
    ...
    'IsEnabled' : {
        ...
        'impl' : [
            ...
            '        return _context->dispatchGL.glIsEnabled( ${arg0plus} );',
            '    return enabled;',
            '}',
        ]
    },
...
#           'gl(Vertex|Normal|Color|SecondaryColor|FogCoord|TexCoord)Pointer',
    ...
    'FfnShadeModel' : {
        ...
        'impl' : [
          ...
          '  _context->dispatchGL.glShadeModel(${arg0plus});',
          '}',
          ],
    },
    'FfnShadow' : {
        ...
        'impl' : [
            ...
            '    _context->dispatchGL.gl${m1}( ${arg0plus} );',
            '}',
            ],
    },
    'FfnShadowProgram' : {
    ...
    'FfnGetTexEnv' : {
        ...
        'impl' : [
            ...
            '    _context->dispatchGL.glGetTexEnv${m1}${m2}${m3}( ${arg0plus} );',
            '}',
        ],
    },
    'FfnLightMatModel' : {
    ...
    'FfnTexGen' : {
        ...
        'impl' : [
            ...
            '    _context->dispatchGL.glTexGen${m1}${m2}( ${arg0plus} );',
            '}',
        ],
    },
    'FfnAlphaFunc' : {
    ...
    'FfnGetBoolean' : {
        ...
        'impl' : [
            ...
            '    _context->dispatchGL.glGetBooleanv( ${arg0plus} );',
            '}',
        ],
    },
    'FfnGet' : {
        ...
        'impl' : [
            ...
            '    _context->dispatchGL.glGet${m1}v( ${arg0plus} );',
            '}',
        ],
    },
    'FfnGetMultiTexGenv' : {
        ...
        'impl' : [
            ...
            '    _context->dispatchGL.glGetMultiTexGen${m1}vEXT( ${arg0plus} );',
            '}',
        ],
    },
    'FfnGetTexGenv' : {
        ...
        'impl' : [
            ...
            '    _context->dispatchGL.glGetTexGen${m1}v( ${arg0plus} );',
            '}',
        ],
    },
    ...
    'Uniform' : {
        ...
        'impl' : [ 
          ...
          '} else {',
          '  _context->dispatchGL.${m0}( ${arg0plus} );',
          '}',
        ],
    },
    'Uniformv' : {
