...
dsaFormulae = {
    ...
    'DsaGetCommands1' : {
        ...
        'impl' : [
            ...
            '  _context->emu.curr.glGet${m1}${m2}v${m3}(${arg0}, ${arg1}, ${arg2});',
            '}',
        ],
    },
    'DsaGetCommands2' : {
        ...
        'impl' : [
            '// if ( ! _context->dsa->GetIndexedv( _context, ${arg0}, ${arg1}, ${arg2} ) ) {',
            '//     _context->emu.curr.glGetPointerIndexedvEXT(${arg0}, ${arg1}, ${arg2});',
            '// }',
        ],
    },
    'DsaGetCommands3' : {
        ...
        'impl' : [
            ...
            '_context->emu.curr.glGetIntegerv(${arg1plus});',
        ],
    },
    'SelectorIsEnabled' : {
        'entries' : [ 'glIsEnabled' ],
    ...
    'MatrixMode' : {
        ...
        'impl' : [
            ...
            '  _context->emu.curr.glMatrixMode(${arg0});',
            '}',
        ],
    },
    'MatrixLoadMultStack' : {
        ...
        'impl' : [
            ...
            '_context->emu.curr.gl${m1}${m2}Matrix${m3}(${arg1plus});',
        ],
    },
    'MatrixTransform' : {
        'entries' : [
        ...
        'impl' : [
            '_context->dsa->DsaMatrixMode( _context, ${arg0} );',
            '_context->emu.curr.gl${m1}${m2}(${arg1plus});',
        ],
    },
    ...
    'ClientActiveTexture' : {
        ...
        'impl' : [
            ...
            '  _context->emu.curr.glClientActiveTexture( ${arg0} );',
            '}',
        ],
    },
    ...
    'ClientIndexed' : {
        ...
        'impl' : [
            ...
            '_context->emu.curr.gl${m1}ClientState( ${arg0} );',
        ],
    },
    'ClientTexCoords' : {
        ...
        'impl' : [
            ...
            '_context->emu.curr.glTexCoordPointer( ${arg1plus} );',
        ],
    },
    'EnableIndexed' : {
    ...
    'ActiveTexture' : {
        ...
        'impl' : [
            ...
            '    _context->emu.curr.glActiveTexture( ${arg0} );',
            '}',
        ],
    },
    'TexCommands' : {
    ...
    'MultiActiveTexCommands' : {
        ...
        'impl' : [
            ...
            '_context->emu.curr.${nondsa}( ${arg1plus} );',
        ],
    },
    'BindTexture' : {
        ...
        'impl' : [
            ...
            '    _context->emu.curr.glBindTexture( ${arg0}, ${arg1} );',
            '}',
        ],
    },
    'BindMultiTexture' : {
        ...
        'impl' : [
            ...
            '_context->emu.curr.glBindTexture( ${arg1plus} );',
        ],
    },
    ...
    'UseProgram' : {
        ...
        'impl' : [
            ...
            '  _context->emu.curr.glUseProgram(${arg0});',
            '}',
        ],
    },
    ...
    'DsaProgramCommands' : {
        ...
        'impl' : [
            ...
            '_context->emu.curr.glUniform${m1}${m2}${m3}${m4}( ${arg1plus} );',
        ],
    },
    ...
    'BindAsmProgram' : {
        ...
        'impl' : [
            ...
            '    _context->emu.curr.glBindProgramARB( ${arg0}, ${arg1} );',
            '}',
        ],
    },
    'AsmProgram' : {
    ...
    'BindFramebuffer' : {
        ...
        'impl' : [
            ...
            '    _context->emu.curr.glBindFramebuffer( ${arg0}, ${arg1} );',
            '}',
        ],
    },
    ...
    'SelectorFramebufferCommands2' : {
        ...
        'impl' : [
            '_context->dsa->DsaFramebuffer( _context, GL_FRAMEBUFFER, ${arg0});',
            '_context->emu.curr.${nondsa}( GL_FRAMEBUFFER, ${arg1plus} );',
        ],
    },
    ...
    'SelectorFramebufferCommands4' : {
        ...
        'impl' : [
            '_context->dsa->DsaFramebuffer( _context, GL_FRAMEBUFFER, ${arg0});',
            'return _context->emu.curr.glCheckFramebufferStatus( ${arg1plus} );',
        ],
    },
    ...
    'BindRenderbuffer' : {
        ...
        'impl' : [
            ...
            '    _context->emu.curr.glBindRenderbuffer( ${arg0}, ${arg1} );',
            '}',
        ],
    },
    ...
    'SelectorRenderbufferCommands2' : {
        ...
        'impl' : [
            ...
            '_context->emu.curr.${nondsa}( GL_RENDERBUFFER, ${arg1plus} );',
        ],
    },
    ...
    'PushClientAttribDefault' : {
        ...
        'impl' : [
            'Dispatch::GL &tbl = _context->emu.curr;',
    ...
    'BindVertexArray' : {
        ...
        'impl' : [
            ...
            '    _context->emu.curr.glBindVertexArray( ${arg0} );',
            '}',
        ],
    },
    ...
    'BindBuffer' : {
        ...
        'impl' : [
            ...
            '    _context->emu.curr.glBindBuffer(${arg0}, ${arg1});',
            '}',
        ],
    },
    ...
    'DsaBufferCommands' : {
        ...
        'impl' : [
            ...
            '_context->emu.curr.gl${m1}${m2}Buffer${m3}( GL_ARRAY_BUFFER, ${arg1plus} );',
        ],
    },
    'DsaBufferCommands2' : {
        ...
        'impl' : [
            '_context->dsa->DsaBuffer( _context, ${arg0});',
            'return _context->emu.curr.gl${m1}Buffer${m2}( GL_ARRAY_BUFFER, ${arg1plus} );',
        ],
    },
    'DsaBufferCommands3' : {
        ...
        'impl' : [
            '_context->dsa->DsaBuffer( _context, ${arg0});',
            'return _context->emu.curr.glUnmapBuffer( GL_ARRAY_BUFFER );',
        ],
    },
    'DsaVertexArrayOffsetCommands3' : {
        ...
        'impl' : [
            ...
            '_context->emu.curr.gl${m1}Pointer( ${arg2}, reinterpret_cast<const GLvoid *>(${arg3}) );',
        ],
    },
    'DsaVertexArrayPointerOffsets4' : {
        ...
        'impl' : [
            '_context->dsa->DsaVao( _context, ${arg0} );'
            '_context->dsa->DsaBuffer( _context, ${arg1} );',
            '_context->emu.curr.gl${m1}Pointer( ${arg2}, ${arg3}, reinterpret_cast<const GLvoid *>(${arg4}) );',
        ],
    },
    'DsaVertexArrayOffsetCommands5' : {
        ...
        'impl' : [
            '_context->dsa->DsaVao( _context, ${arg0} );'
            '_context->dsa->DsaBuffer( _context, ${arg1} );',
            '_context->emu.curr.gl${m1}Pointer( ${arg2}, ${arg3}, ${arg4}, reinterpret_cast<const GLvoid *>(${arg5}) );',
        ],
    },
    'DsaVertexArrayOffsetCommands6' : {
        ...
        'impl' : [
            '_context->dsa->DsaVao( _context, ${arg0} );'
            '_context->dsa->DsaBuffer( _context, ${arg1} );',
            '_context->emu.curr.gl${m1}Pointer( ${arg2}, ${arg3}, ${arg4}, ${arg5}, reinterpret_cast<const GLvoid *>(${arg6}) );',
        ],
    },
    'DsaVertexArrayOffsetCommands6EXT' : {
        ...
        'impl' : [
            '_context->dsa->DsaVao( _context, ${arg0} );'
            '_context->dsa->DsaBuffer( _context, ${arg1} );',
            '_context->emu.curr.gl${m1}PointerEXT( ${arg2}, ${arg3}, ${arg4}, ${arg5}, reinterpret_cast<const GLvoid *>(${arg6}) );',
        ],
    },
    'DsaVertexArrayOffsetCommands7' : {
        ...
        'impl' : [
            '_context->dsa->DsaVao( _context, ${arg0} );'
            '_context->dsa->DsaBuffer( _context, ${arg1} );',
            '_context->emu.curr.gl${m1}Pointer( ${arg2}, ${arg3}, ${arg4}, ${arg5}, ${arg6}, reinterpret_cast<const GLvoid *>(${arg7}) );',
        ],
    },
    'Delete' : {
        'entries' : [
    ...
    'VertexArrayEnable' : {
        ...
        'impl' : [
            ...
            '  _context->emu.curr.gl${m1}ClientState( GL_TEXTURE_COORD_ARRAY );',
            '} else {',
            '  _context->emu.curr.gl${m1}ClientState( ${arg1} );',
            '}'
        ],
    },
    'VertexArrayAttribEnable' : {
        ...
        'impl' : [
            '_context->dsa->DsaVao( _context, ${arg0} );',
            '_context->emu.curr.gl${m1}VertexAttribArray( ${arg1} );'
        ],
    },
}
