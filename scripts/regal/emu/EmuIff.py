...
iffFormulae = {
    ...
    'IsEnabled' : {
        ...
        'impl' : [
            ...
            '        return _context->emu.curr.glIsEnabled( ${arg0plus} );',
            '    return enabled;',
            '}',
        ]
    },
...
#           'gl(Vertex|Normal|Color|SecondaryColor|FogCoord|TexCoord)Pointer',
    ...
    'FfnShadeModel' : {
        ...
        'impl' : [
          ...
          '  _context->emu.curr.glShadeModel(${arg0plus});',
          '}',
          ],
    },
    'FfnShadow' : {
    ...
    'FfnGetTexEnv' : {
        ...
        'impl' : [
            ...
            '    _context->emu.curr.glGetTexEnv${m1}${m2}${m3}( ${arg0plus} );',
            '}',
        ],
    },
    'FfnLightMatModel' : {
    ...
    'FfnTexGen' : {
        ...
        'impl' : [
            ...
            '    _context->emu.curr.glTexGen${m1}${m2}( ${arg0plus} );',
            '}',
        ],
    },
    'FfnAlphaFunc' : {
    ...
    'FfnGetBoolean' : {
        ...
        'impl' : [
            ...
            '    _context->emu.curr.glGetBooleanv( ${arg0plus} );',
            '}',
        ],
    },
    'FfnGet' : {
    ...
    'FfnGetMultiTexGenv' : {
        ...
        'impl' : [
            ...
            '    _context->emu.curr.glGetMultiTexGen${m1}vEXT( ${arg0plus} );',
            '}',
        ],
    },
    'FfnGetTexGenv' : {
        ...
        'impl' : [
            ...
            '    _context->emu.curr.glGetTexGen${m1}v( ${arg0plus} );',
            '}',
        ],
    },
